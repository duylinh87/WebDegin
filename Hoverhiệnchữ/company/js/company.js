jQuery(function($) {
    ...
    $(function() {
        ...
        $('#company .item-work').hover(
			function(){
				$(this).find('.text-hover').fadeIn();
            },
            function(){
                $(this).find('.text-hover').fadeOut();
            },
		);


   $('#company .title-page, #company .item-work ,#company .title-main, #company .item-data   ').addClass('js-fadein animated')
