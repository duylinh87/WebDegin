jQuery(function($) {
    ...
    $(function () {
        $('#department .item-tabsDepartment .show-tabs').click(function (event) {
            event.preventDefault();
            $("#department .department-content").removeClass("active");
            $('#department .item-tabsDepartment .show-tabs').removeClass("active");
            var url = $(this).attr('href');
            var dest = url.split('#');
            var target = dest[1];
    ...
    $(function () {
        $('#department .item-departmentInfo .show-tabs').click(function (event) {
            event.preventDefault();

            var url = $(this).attr('href');
            var dest = url.split('#');
            var target = dest[1];
            $('#' + target).parents(".department-content").find(".departmentInfo-content").removeClass("active");
            $('#' + target).addClass("active");

            $(this).parents(".list-departmentInfo").find(".show-tabs").removeClass('active');
            $(this).addClass("active");
        });
    });
