jQuery(function($) {
   ...
   let voice = $('#workplace .box-list .list-item')
   let voiceProfile = $('#workplace .place')
   ...
   $(voice).click(function (e) {
        ...
        if( indexVoice === 1) {
             $('.content-main').css('background', "#fafafa");
        }
        else {
            $('.content-main').css('background', "white");
        }
   });
   $('#workplace .place').addClass('js-fadein animated')
   $('#workplace .title-place, .room-place ,.album ').addClass('js-fadein animated')
