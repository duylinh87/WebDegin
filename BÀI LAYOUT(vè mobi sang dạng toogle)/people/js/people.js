jQuery(function ($) {
    ...
    $( '#people .col-boxPeople').click(function(){
        part = $(this).attr('href');
        console.log (part)
   ...
   $( '#people .title-toogle').click(function(){
       console.log ("fdfsf")
      $(this).next("#people .box-toogle").slideToggle()

   })
    $('#people .item-people  ,#people .box-message    ').addClass('js-fadein animated')
