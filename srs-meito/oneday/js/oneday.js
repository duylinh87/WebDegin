jQuery(function($) {
    ...
    $('#oneday  .back-top').click(function () {
     ...
     $('#oneday .time-work .time-content .time-item .box-work .time-heading').addClass('js-fadein animated')
     $('#oneday .time-work .time-content .time-item .box-work .text').addClass('js-fadein animated')
     $('#oneday .time-work .time-content .time-item .pic-item, #oneday .time-work .time-content .time-item .time-main ').addClass('js-fadein animated')
