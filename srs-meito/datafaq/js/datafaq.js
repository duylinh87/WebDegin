jQuery(function($) {
    ...
    $('#datafaq  .back-top').click(function () {
    ...
    $('#datafaq .content .content-main .icon-box .icon-item').addClass('js-fadein animated')
    $('#datafaq .chart').addClass('js-fadein animated')
    $('#datafaq .content:nth-child(2) .box-main .faq-item ').addClass('js-fadein animated')
    // $('#datafaq .chart .text-chart').addClass('js-fadein animated')
