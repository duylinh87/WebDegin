...
jQuery(function($) {
  ...
  $(function(){
    ...
    i.each(function(){function i(){var i=parseInt($(window).width());
      i>=a?c.attr('src',c.data('img').replace(s,t)).css({visibility:'visible'}):c.attr('src',c.data('img')).css({visibility:'visible'})}
      var c=$(this);$(window).resize(function(){i()}),i()})});
      $('#oneday .time-content').addClass('js-fadein animated')
      $('#oneday .box-info').addClass('js-fadein animated')
      // $('#oneday .messge-text ').addClass('js-fadein animated')
      // $('#oneday .messge-img').addClass('js-fadein animated')
      $('#oneday .messge').addClass('js-fadein animated')
