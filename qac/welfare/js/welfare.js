...
jQuery(function($) {
    ...
    $("#welfare .back-top .img-back").click(function () {
      ...
      $('#welfare .title-item,#welfare .title-content,#welfare .note-title').addClass('js-fadein animated')
      $('#welfare .box-item .item-content .item,#welfare .content-two .list-one,#welfare .content-two .list-two,#welfare .btn-link ').addClass('js-fadein animated')
