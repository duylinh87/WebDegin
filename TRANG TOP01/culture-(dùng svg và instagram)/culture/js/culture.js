jQuery(function($) {
    ...
    // js fadeIn Down
    $(window).scroll(function () {
        $('.animatedFadeInDown').each(function () {
            var ptop = $(this).offset().top;
            var scroll = $(window).scrollTop();
            var windowHeight = $(window).height();
            if (scroll > ptop - windowHeight) {
    ...
    $(function () {
        ...
        //slider mainimg
        var slider01 = $('#culture .list-aboutUs');
        var bxslider01 = slider01.bxSlider({
            ...
            speed: 800,
            infiniteLoop: true,
            nextText: '<img class="icon-slider switch-img retina-img" data-img="./images/culture/culture_ico02_sp.png" src="./images/culture/culture_ico02_pc.png" alt="">',
