jQuery(function($) {
	...
	$(function () {
	    $("#pamphlet #form-download-materials .form-submit").click(function(){
	        $("#pamphlet .form-pamphlet .heading-block .t2.begin").hide();
	        $("#pamphlet .form-pamphlet .heading-block .t2.success").show();
	    });
    });

    var active = 'slider-active';
    var slider = $('#pamphlet .main-slider');
