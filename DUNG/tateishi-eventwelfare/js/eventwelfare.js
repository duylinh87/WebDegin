jQuery(function($) {
    ...
    $('#eventwelfare .event-block .event-block-content.block01 .list-info-event').slick({
        dots: true,
        arrows: false,
        infinite: false,
        slidesToShow: 3,
    ...
    $('#eventwelfare .event-block .event-block-content.block02 .list-info-event').slick({
        dots: true,
        arrows: false,
        infinite: false,
        slidesToShow: 2,
    ...
    $('#eventwelfare .event-block .event-block-content.block03 .list-info-event').slick({
        dots: true,
        arrows: false,
        infinite: false,
        slidesToShow: 3,
    ...
    $('#eventwelfare .event-block .event-block-content.block04 .right-content .list-info-event02').slick({
        dots: true,
        arrows: false,
        infinite: false,
        slidesToShow: 2,
