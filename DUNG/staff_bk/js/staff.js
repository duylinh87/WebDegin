jQuery(function($) {
    ...
    //js scroll to block
    $("#staff .block-tabs .tab-item .item-action").click(function(event) {
        ...
        // $("#staff .animatedFadeInUp").removeClass("fadeInUp");
        return false;
    });

    var hoverMore = $( "#staff .block-tabs .tabs-list-content .tab-item .more" );

    hoverMore.mouseenter(function() {
        $(this).parents(".tab-item").addClass("is-active");
    });

    hoverMore.mouseleave(function() {
        $(this).parents(".tab-item").removeClass("is-active");
    });
