jQuery(function($) {
    ...
    var slider = $('#top .slider-recommended-job');
    ...
    var bxslider = slider.bxSlider({
        ...
        useCSS: true,
        infiniteLoop: true,
        nextText: '<img class="switch-img retina-img" data-img="./images/top/top_ico_next_slider.png" src="./images/top/top_ico_next_slider.png" alt="">',
        prevText: '<img class="switch-img retina-img" data-img="./images/top/top_ico_prev_slider.png" src="./images/top/top_ico_prev_slider.png" alt="">',
