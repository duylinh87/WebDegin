...
// Scroll body
    ...
    //js for the event click on the people image
    $("#workplace .list-item-team .image_wrap").click(function () {
        const dataPerson = $(this).attr("data-alt");
        $("#workplace .person-block").each(function () {
            const dataBlock = $(this).attr("data-alt");
            if(dataBlock == dataPerson){
