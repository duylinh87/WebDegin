jQuery(function($) {
    ...
    $('#careerplan .education-program .list-info-education').bxSlider({
        // slideWidth: 1000,
        auto: true,
        pause: 4000,
        speed: 600,
        ...
        infiniteLoop: true,
        pager: false,
        nextText: '<img class="icon-slider" src="./images/careerpaln_arrow_next.png">',
        prevText: '<img class="icon-slider" src="./images/careerpaln_arrow_prev.png">',
    });
