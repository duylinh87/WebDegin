jQuery(function($) {
    ...
    $('#servicestation .shop-list-content .list-map-popup').slick({
        dots: true,
        infinite: false,
        slidesToShow: 20,
        slidesToScroll: 1,
        responsive: [
            {
                ...
                settings: {
                    ...
                    slidesToShow: 1,
                    slidesToScroll: 1,
                    nextArrow: '<span class="slick-next slick-arrow"><img class="img-icon" src="./images/servicestation_ico_next_slider.png"></span>',
                    prevArrow: '<span class="slick-prev slick-arrow"><img class="img-icon" src="./images/servicestation_ico_prev_slider.png"></span>'
                }
            }
        ]
    });
