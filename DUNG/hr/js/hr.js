jQuery(function($) {
    ...
    //scroll
    $(function () {
        $('#hr .action').click(function (event) {
            $("#hr .inner-hr").removeClass("active");
            $("#hr .animatedFadeInUp").removeClass("fadeInUp");
            $("#hr .marker-animation").removeClass("active");
            $('#hr .common-pagelink-hr .common-pagelink-item-hr a').removeClass("active");
