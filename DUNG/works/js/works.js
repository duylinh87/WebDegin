jQuery(function($) {
    ...
    var slider = $('#works .list-slider-works');
   ...
   var bxslider = slider.bxSlider({
        ...
        speed: 800,
        infiniteLoop: true,
        nextText: '<img class="icon-slider" src="./images/works/works_ico_next_slider.png" alt="">',
        prevText: '<img class="icon-slider" src="./images/works/works_ico_prev_slider.png" alt="">',
        ...
        onSliderResize:function() {
            setTimeout(function(){
                var heightResize = slider.find(".slider-active").height();
                slider.parents(".bx-viewport").css("height", heightResize);
            }, 200);
        },
    });
