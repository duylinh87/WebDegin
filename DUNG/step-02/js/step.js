jQuery(function($) {
    ...
    $('#step .item-action').click(function (event) {
        event.preventDefault();
        $("#step .item-tab-service .item-action").removeClass("active");
        $("#step .service-block").removeClass("active");
        ...
        $('#step .item-action-toggle').removeClass("active");
        $(target_offset_a).prev().find(".item-action-toggle").addClass("active");
        return false;
    });

    $('#step .item-action-toggle').click(function (event) {
        event.preventDefault();
        $("#step .item-tab-service .item-action-toggle").removeClass("active");
        $(this).toggleClass("active");
        var url = $(this).attr('href');
        var dest = url.split('#');
        var target = dest[1];
    ...
    $('#step .bottom-toggle .item-action-bottom').click(function (event) {
        event.preventDefault();
        var url = $(this).attr('href');
        var dest = url.split('#');
        var target = dest[1];
    ...
    $("#step .item-asked-questions .title").click(function () {
    ...
    window.addEventListener("resize", function() {
        if (window.matchMedia("(min-width: 768px)").matches) {
            $("#step .tabs-service .item-tab-service").each(function () {
            ...
            $("#step .service-block").each(function () {
