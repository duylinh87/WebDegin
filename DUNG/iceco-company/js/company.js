jQuery(function($) {
    ...
    $(function(){
        $('#company .tab-action').click(function(event){
            event.preventDefault();

            $("#company .headquarter-tabs .tabs-show .item-tab").removeClass("active");
            $("#company .headquarter-tabs .headquarter-content").removeClass("active");
            ...
            $(this).parents(".item-tab").addClass("active");
            return  target_offset.addClass("active");
