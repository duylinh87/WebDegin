jQuery(function($) {
    ...
    $('#bxslider1').slick({
        ...
        fade: true,
        speed: 1000,
        nextArrow: '<a class="slick-next" href="#"><img class="switch-img retina-img" data-img="./images/faq/faq_ico_next_slider.png" src="./images/faq/faq_ico_next_slider.png"></a>',
        prevArrow: '<a class="slick-prev" href="#"><img class="switch-img retina-img" data-img="./images/faq/faq_ico_prev_slider.png" src="./images/faq/faq_ico_prev_slider.png"></a>',
        asNavFor: '#bxslider2'
    });
    $('#bxslider2').slick({
        slidesToShow: 20,
